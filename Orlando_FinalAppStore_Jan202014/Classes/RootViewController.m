...
- (void)viewDidLoad {
	...
	//[NSTimer scheduledTimerWithTimeInterval:1.3 target:self selector:@selector(MoveToMainMenu) userInfo:nil repeats:NO];
    [super viewDidLoad];
}

-(void)MoveToMainMenu{
	if(MainMenuView == nil){
		MainMenuView = [[MainMenuViewController alloc] init];	
	}
